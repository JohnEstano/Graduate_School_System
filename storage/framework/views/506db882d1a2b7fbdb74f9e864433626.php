...
<body>
    <div class="email-wrapper">
        ...
        <h1>Welcome to <?php echo e($adviserFullName); ?>'s Advisery</h1>
            ...
            <p class="message">
                Congratulations! We are pleased to inform you that <strong><?php echo e($adviserFullName); ?></strong> has accepted your advisery assignment and will be guiding you through your academic journey in the Graduate School.
            </p>
            ...
            <div class="info-box">
                ...
                <div class="value"><?php echo e($adviserProgram); ?></div>
            </div>
            ...
            <div class="notice-box">
                ...
                <div class="details">
                    You can reach <strong><?php echo e($adviserFullName); ?></strong> at <strong><?php echo e($adviserEmail); ?></strong>. Please allow 24-48 hours for a response. For urgent academic matters, you may also contact the Graduate School Office.
                </div>
            </div>

            <div style="text-align: center;">
                <a href="<?php echo e(url('/student/dashboard')); ?>" class="cta-button">
...
<?php /**PATH C:\xampp\htdocs\Graduate_School_System\resources\views/emails/student-accepted-by-adviser.blade.php ENDPATH**/ ?>