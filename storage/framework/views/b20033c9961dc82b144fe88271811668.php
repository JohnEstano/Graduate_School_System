                        ...
                        <tr>
                            <td style="padding: 30px;">
                                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                    <tr>
                                        <td width="50">
                                            <img src="<?php echo e(asset('gss-uic-logo-v2.png')); ?>" alt="UIC Graduate School Logo"
                                                class="logo">
                                        </td>
                                        <td align="right">
                                ...
                                <div style="text-align: center;">
                                    <a href="<?php echo e(url('/login')); ?>" class="cta-button">
...
</html><?php /**PATH C:\xampp\htdocs\Graduate_School_System\resources\views/emails/WelcomeMail.blade.php ENDPATH**/ ?>