...
<body>
    <div class="email-wrapper">
        <div class="email-container">
            ...
            <p class="message">
                Great news! A student that was pre-assigned to you by <strong><?php echo e($coordinatorName); ?></strong> 
            ...
            <div class="info-box">
                ...
                <div class="info-row">
                    ...
                    <span class="info-value"><?php echo e($studentName); ?></span>
                </div>
                <div class="info-row">
                    <span class="info-label">Email:</span>
                    <span class="info-value"><?php echo e($studentEmail); ?></span>
                </div>
                <div class="info-row">
                    <span class="info-label">Student Number:</span>
                    <span class="info-value"><?php echo e($studentNumber); ?></span>
                </div>
                <div class="info-row">
                    <span class="info-label">Program:</span>
                    <span class="info-value"><?php echo e($studentProgram); ?></span>
                </div>
            </div>
            ...
            <p class="message" style="font-size: 14px; color: #6b7280;">
                ...
                the Graduate School office or <strong><?php echo e($coordinatorName); ?></strong>.
            </p>
...
<?php /**PATH C:\xampp\htdocs\Graduate_School_System\resources\views/emails/student-registered-notification.blade.php ENDPATH**/ ?>