...
<body>
    <div class="email-wrapper">
        ...
        <h1>Adviser Assignment Update</h1>
            ...
            <p class="message">
                <strong>Dear <?php echo e($studentFullName); ?>,</strong>
            </p>
            <p class="message">
                We regret to inform you that <strong><?php echo e($adviserFullName); ?></strong> was unable to accept the adviser assignment for your graduate program at this time.
            </p>
            ...
            <div class="info-box">
                ...
                <div class="value"><?php echo e($adviserFullName); ?></div>
                
                <div class="label"><i class="fas fa-envelope"></i> Email</div>
                <div class="value"><?php echo e($adviserEmail); ?></div>
            ...
            <div class="next-steps-box">
                ...
                <ul>
                    <li><strong>Contact Your Coordinator:</strong> Reach out to <?php echo e($coordinatorName); ?> who will assist you in finding an alternative adviser.</li>
            ...
            <div class="important-notice">
                <div class="title"><i class="fas fa-circle-exclamation"></i> Important: Action Required</div>
                    ...
                    Please contact your coordinator <strong><?php echo e($coordinatorName); ?></strong> as soon as possible to discuss alternative adviser options. Having an assigned adviser is essential for progressing with your thesis/dissertation work.
                </div>
            </div>
            ...
            <div class="coordinator-box">
                ...
                <div class="details">
                    <strong>Name:</strong> <?php echo e($coordinatorName); ?><br>
                    <strong>Email:</strong> <?php echo e($coordinatorEmail); ?><br>
...
<?php /**PATH C:\xampp\htdocs\Graduate_School_System\resources\views/emails/student-rejected-by-adviser.blade.php ENDPATH**/ ?>