                            ...
                            <table className="w-full text-xs table-fixed">
                                <thead>
                                    <tr className="text-gray-500 dark:text-gray-400">
                                        ...
                                        <th className="text-left py-1 px-2 w-1/5">Student</th>
                                        <th className="text-left py-1 px-2 w-1/5">State</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    {top.map((r, idx) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                <td className="truncate py-2 pr-2 w-2/5 font-medium">
                                                    {r.thesis_title || <span className="text-gray-400">N/A</span>}
                                                </td>
                                                <td className="py-2 px-2 w-1/5">
                                                    {student || <span className="text-gray-400">N/A</span>}
                                                </td>
                                                <td className="py-2 px-2 w-1/5">
