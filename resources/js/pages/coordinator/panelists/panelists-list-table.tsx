...
export default function PanelistsListTable({
  ...
  const [panelistTab] = useState<"assignments">("assignments");
    ...
    <>
      ...
      <Dialog open={viewOpen} onOpenChange={(open) => setViewOpen(open)}>
        <DialogContent className="max-w-2xl dark:bg-zinc-800" style={{ minWidth: "520px", maxWidth: "640px" }}>
          ...
          <div className="mt-4">
            {/* Remove Tabs, TabsList, TabsTrigger for "pending", and TabsContent for "pending" */}
            {/* Only show assignments */}
            <div className="flex items-center justify-between mb-2">
              <div className="font-semibold text-sm">Assigned Defenses</div>
