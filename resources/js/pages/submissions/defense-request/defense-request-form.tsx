...
import { Plus, Paperclip, Calendar as CalendarIcon, Check } from "lucide-react"
...
export default function DefenseRequestForm() {
        ...
        <>
          ...
          <div className="mt-4">
            ...
            <Input
              ...
              onChange={(e) => form.setData("schoolId", e.target.value)}
            />
          </div>
          <div className="mt-4">
            <Label>Program</Label>
        ...
        <>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 mt-4">
            <div>
              ...
              <Select
                value={form.data.modeDefense}
                onValueChange={(v) => form.setData("modeDefense", v)}
              >
            ...
            <div>
              ...
              <Select
                value={form.data.defenseType}
                onValueChange={(v) => form.setData("defenseType", v)}
              >
                <SelectTrigger className="w-full">
          ...
          {(
            ...
            <div key={field}>
              ...
              <div className="flex gap-2 items-center">
                ...
                >
                  <Paperclip className="mr-1 h-4 w-4" />Choose File
                </Button>
                <input
                  type="file"
                  name={field}
    ...
    },
    {
      ...
      content: (
        <div className="w-full space-y-4 pb-5">
          ...
          <div className="bg-rose-50 border border-rose-200 rounded-lg p-6 space-y-6">
  ...
  return (
    ...
    >
      ...
      <DialogContent className="w-full max-w-4xl h-[95vh] flex flex-col">
        <DialogHeader>
       ...
       {showSuccessPanel ? (
          <div className="flex-1 flex flex-col items-center justify-center space-y-6 px-4">
            ...
            <p className="text-center text-gray-600">
              Your defense request has been saved successfully.
            </p>
