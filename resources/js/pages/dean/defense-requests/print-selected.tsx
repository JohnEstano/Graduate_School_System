  ...
  <div style={{ fontFamily: "Arial, sans-serif", padding: 32 }}>
    <div style={{ display: "flex", alignItems: "center", marginBottom: 24 }}>
      ...
      <div>
        ...
        <div style={{ fontSize: 13, color: "#888" }}>Defense Requests Report - Dean Review</div>
      </div>
    </div>
    <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 13 }}>
      <thead>
        <tr style={{ background: "#f5f5f5" }}>
          ...
          <th style={{ border: "1px solid #ddd", padding: 8 }}>Coordinator Status</th>
          <th style={{ border: "1px solid #ddd", padding: 8 }}>Dean Status</th>
        </tr>
      </thead>
      <tbody>
        {rows.map((r) => (
          <tr key={r.id}>
            ...
            <td style={{ border: "1px solid #ddd", padding: 8 }}>{r.coordinator_status || 'Pending'}</td>
            <td style={{ border: "1px solid #ddd", padding: 8 }}>{r.dean_status || 'Pending'}</td>
          </tr>
        ))}
      </tbody>
    </table>
