                        ...
                        <tr>
                            <td style="padding: 30px;">
                                    ...
                                    <tr>
                                        <td style="padding: 20px;">
                                            ...
                                            <div style="color: #991b1b; font-size: 14px; margin-bottom: 10px; padding: 10px; background-color: #fef2f2;">
                                                {{ $rejectionReason ?? 'Payment verification failed. Please contact the Registrar\'s office for details.' }}
                                            </div>
                                ...
                                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                    <tr>
                                        <td align="center" style="padding: 20px 0;">
                                            <a href="{{ url('/comprehensive-exam') }}" style="display: inline-block; background-color: #FF4B64; color: #ffffff; padding: 15px 35px; text-decoration: none; font-weight: bold; font-size: 16px;">Resubmit Payment Information</a>
                                        </td>
                                    </tr>
                                </table>
