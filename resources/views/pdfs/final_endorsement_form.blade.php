...
<body>
    <div class="page">
        ...
        <div class="section" style="margin-top: 6px;">
            I have reviewed and fully endorsed the final manuscript attached for evaluation. The manuscript is now ready for final defense.
        </div>
            ...
            <tr>
                <td style="width: 50%;">
                    ...
                    <ol>
                        ...
                        <li>Successfully defended the thesis/dissertation proposal and pre-final stages</li>
                        <li>Made all necessary revisions as recommended by all previous defense panels</li>
                        <li>Completed the final manuscript following the prescribed UIC format</li>
                        <li>Submitted all required documentation and clearances</li>
                    </ol>
                </td>
                <td style="width: 50%;">
                    ...
                    <ol>
                        ...
                        <li>Confirms the final panel members to be approved by the Dean</li>
