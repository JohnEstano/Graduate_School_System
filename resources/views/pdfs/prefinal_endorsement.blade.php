...
<body>
    <div class="page">
        ...
        <table class="footer-table">
            <tr>
                <td style="width: 50%;">
                    Guidelines in Preparing for Thesis / Dissertation Pre-Final Defense:
                    <ol>
                        <li>The applicant for thesis / dissertation pre-final defense must be enrolled in Thesis / Dissertation Writing in the current semester.</li>
                        <li>S/He must secure and accomplish an Application Form from the office of the Dean of Graduate School.</li>
                        <li>When the form is accomplished, s/he must submit application to the Graduate Dean's office and arrange for tentative schedule of pre-final defense.</li>
                    </ol>
                </td>
                <td style="width: 50%;">
                    Process /Procedure for Pre-Final Defense:
                    <ol>
