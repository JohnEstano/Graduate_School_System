import{j as a}from"./app-CQngmq00.js";function d({targetId:n}){const r=()=>{const o=document.getElementById(n);if(!o)return;const t=window.open("","_blank","width=900,height=700");if(!t)return;const i=`
      <style>
